...
await conn.sendAi(m.chat, botname, bienvenida, img, m, rcanal)
  }
...
╰───| ͜͡  ͜͡ᩙ‎ | ͜͡  ͜͡ᩙ‎ | ͜͡ ꒱`
await conn.sendAi(m.chat, botname, bye, img, m, rcanal)
  }
...
│ ‹‹ *Bye* :: *@${m.messageStubParameters[0].split`@`[0]}⁨*
╰───| ͜͡  ͜͡ᩙ‎ | ͜͡  ͜͡ᩙ‎ | ͜͡ ꒱`
await conn.sendAi(m.chat, botname, kick, img, m, rcanal)
}}
