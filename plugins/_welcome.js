...
await conn.sendAi(m.chat, textbot, bienvenida, img, img, canal)
  }
...
╰───| ͜͡  ͜͡ᩙ‎ | ͜͡  ͜͡ᩙ‎ | ͜͡ ꒱`
await conn.sendAi(m.chat, textbot, bye, img, img, canal)
  }
...
│ ‹‹ *Bye* :: *@${m.messageStubParameters[0].split`@`[0]}⁨*
╰───| ͜͡  ͜͡ᩙ‎ | ͜͡  ͜͡ᩙ‎ | ͜͡ ꒱`
await conn.sendAi(m.chat, textbot, kick, img, img, canal)
}}
